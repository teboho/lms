...
export const postAuthSuccessAction = createAction(
    ...
    (authObj: AUTH_OBJ_TYPE): AUTH_CONTEXT_STATE_TYPE => ({ isSuccess: true, isInProgress: false, isError: false, authObj})
);
...
export const postAuthErrorAction = createAction(
    AuthActionEnums.PostAuthSuccess,
    (): AUTH_CONTEXT_STATE_TYPE => ({ isSuccess: false, isInProgress: false, isError: true, authObj: undefined})
);