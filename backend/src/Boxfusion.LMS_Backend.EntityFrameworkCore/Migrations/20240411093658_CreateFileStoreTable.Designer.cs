...
namespace Boxfusion.LMS_Backend.Migrations
{
    ...
    [Migration("20240411093658_CreateFileStoreTable")]
    partial class CreateFileStoreTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.History", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Loan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Preference", b =>
                {
                    ...
                    b.Property<Guid>("TertiaryCategoryId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Boxfusion.LMS_Backend.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Boxfusion.LMS_Backend.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Book", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Domain.Author", "AuthorModel")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Boxfusion.LMS_Backend.Domain.Category", "CategoryModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.History", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Domain.Book", "BookModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Boxfusion.LMS_Backend.Domain.Payment", b =>
                {
                    b.HasOne("Boxfusion.LMS_Backend.Domain.Loan", "LoanModel")
                        .WithMany()
